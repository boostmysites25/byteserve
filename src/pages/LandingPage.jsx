    ...
    <>
      <section id="banner" className="relative min-h-screen bg-black/50">
        <div className="pt-[13rem] pb-[5rem]">
          <div className="wrapper flex flex-col gap-7 justify-center h-full">
            ...
            <h1 data-aos="fade-up" data-aos-delay="100" className="heading text-white">
            ...
            <p data-aos="fade-up" data-aos-delay="200" className="text-white text-lg max-w-3xl backdrop-blur-sm bg-black/10 p-4 rounded-lg">
              {isWeb
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-4" data-aos="fade-up" data-aos-delay="300">
              <ArrowScrollButton to="services">Explore Our Services</ArrowScrollButton>
              <ArrowScrollButton to="contact" variant="secondary">Get a Free Quote</ArrowScrollButton>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-white">
        <div className="wrapper">
          ...
          <div className="grid md:grid-cols-4 gap-6 text-center">
            <div data-aos="fade-up" className="p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-all hover:border-primary/30">
              <Zap className="w-10 h-10 mx-auto text-primary mb-3" />
              <h3 className="text-lg font-semibold mb-2">Fast Delivery</h3>
              <p className="text-gray-600">Efficient development processes that get your solution to market quickly</p>
            </div>
            
            <div data-aos="fade-up" data-aos-delay="100" className="p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-all hover:border-primary/30">
              <Shield className="w-10 h-10 mx-auto text-primary mb-3" />
              <h3 className="text-lg font-semibold mb-2">Secure & Reliable</h3>
              <p className="text-gray-600">Built with security best practices and rigorous testing standards</p>
            </div>
            
            <div data-aos="fade-up" data-aos-delay="200" className="p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-all hover:border-primary/30">
              <BarChart className="w-10 h-10 mx-auto text-primary mb-3" />
              <h3 className="text-lg font-semibold mb-2">Data-Driven</h3>
              <p className="text-gray-600">Solutions that provide actionable insights to improve your business</p>
            </div>
            
            <div data-aos="fade-up" data-aos-delay="300" className="p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-all hover:border-primary/30">
              <Users className="w-10 h-10 mx-auto text-primary mb-3" />
              <h3 className="text-lg font-semibold mb-2">User-Focused</h3>
              <p className="text-gray-600">Designed with your users in mind for maximum engagement and satisfaction</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-[5rem] bg-gradient-to-b from-white to-gray-100">
        <div className="wrapper space-y-5">
          ...
          <p data-aos="fade-up" className="text-center max-w-3xl mx-auto text-gray-700">
            We've helped businesses across multiple sectors leverage technology to solve 
            complex challenges and create new opportunities. Our industry-specific expertise 
            allows us to build solutions that address your unique requirements.
          </p>
          ...
          <div className="text-center pt-8">
            <p className="text-gray-700 mb-4">Don't see your industry? We work with businesses of all types.</p>
            <ArrowScrollButton to="contact">Let's Discuss Your Needs</ArrowScrollButton>
          </div>
        </div>
      </section>
      ...
      <section className="pt-[4rem] pb-[2rem] bg-gradient-to-b from-white to-gray-50">
        ...
        <p data-aos="fade-up" className="text-center max-w-3xl mx-auto wrapper mb-10 text-gray-700">
          These principles guide everything we do, from how we build technology to how we work with our clients
        </p>
        <div
          data-aos="fade-up"
          ...
          {[
            {
              ...
              styles: "bg-[#7C42DA] lg:rotate-[-18deg] lg:translate-y-[8rem] text-white",
            },
            {
              ...
              styles: "bg-[#F8B000] lg:rotate-[-10deg] lg:translate-y-[3rem] text-white",
            },
            {
            ...
            },
            {
              ...
              styles: "bg-[#D1B9F7] lg:rotate-[10deg] lg:translate-y-[3rem] text-white",
            },
            {
        ...
        >
          ...
          <div className="p-10 md:p-16 text-white text-start space-y-5 max-w-2xl">
            ...
            <p className="text-lg max-w-md">
              We follow a structured yet flexible approach that ensures clear communication, 
              quality deliverables, and solutions that truly meet your business needs.
            </p>
            <ul className="space-y-3 max-w-md">
              <li className="flex items-start">
                ...
                <span><strong>Discovery & Planning</strong> - We understand your goals and define the roadmap</span>
              </li>
              <li className="flex items-start">
                ...
                <span><strong>Design & Prototyping</strong> - We create the blueprint for your solution</span>
              </li>
              <li className="flex items-start">
                ...
                <span><strong>Development & Testing</strong> - We build and validate with rigorous quality standards</span>
              </li>
              <li className="flex items-start">
                ...
                <span><strong>Deployment & Support</strong> - We launch and provide ongoing assistance</span>
              </li>
            </ul>
            <div className="pt-7">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div data-aos="fade-left" className="md:w-2/3 space-y-4">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="pt-4">
                  <ArrowScrollButton to="contact">Connect With Our Team</ArrowScrollButton>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="pt-[6rem] pb-[4rem] wrapper space-y-3">
        ...
        <p data-aos="fade-up" className="text-center max-w-3xl mx-auto mb-10 text-gray-700">
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            <div className="flex flex-col md:w-8/12 lg:w-9/12">
              <div className="md:px-[2.5rem]">
                <h3 className="text-2xl font-bold text-white mb-4">Problem Solvers, Not Just Coders</h3>
                <p className="md:text-lg text-white">
                  We don't just write code – we solve problems. Our team brings together 
                  technical expertise and business understanding to create solutions that 
                  make a real difference. We take the time to understand your goals and 
                  challenges before proposing the right technology approach.
                </p>
                <Quote
          ...
          >
            <div className="flex flex-col md:w-8/12 lg:w-9/12">
              <div className="md:px-[2.5rem]">
                <h3 className="text-2xl font-bold text-white mb-4">End-to-End Expertise</h3>
                <p className="md:text-lg text-white">
                  Our full-stack capabilities mean we can handle every aspect of your 
                  project – from front-end design to back-end architecture, database 
                  optimization, and cloud infrastructure. This integrated approach 
                  ensures a seamless experience and consistent quality throughout.
                </p>
                <Quote
                  className="size-10 fill-white/20 self-end mt-3"
                  strokeWidth={0}
          ...
          >
            <div className="flex flex-col md:w-8/12 lg:w-9/12">
              <div className="md:px-[2.5rem]">
                <h3 className="text-2xl font-bold text-white mb-4">Future-Proof Solutions</h3>
                <p className="md:text-lg text-white">
                  We build with the future in mind. Our solutions are designed to scale 
                  as your business grows, adapt to changing requirements, and integrate 
                  with new technologies. We use modern frameworks and best practices to 
                  ensure your investment continues to deliver value for years to come.
                </p>
                <Quote
                  className="size-10 fill-white/20 self-end mt-3"
                  strokeWidth={0}
          ...
          >
            <div className="flex flex-col md:w-8/12 lg:w-9/12">
              <div className="md:px-[2.5rem]">
                <h3 className="text-2xl font-bold text-white mb-4">Cross-Industry Experience</h3>
                <p className="md:text-lg text-white">
                  Our experience spans multiple industries and technologies, giving us 
                  a unique perspective on what works. We've helped startups launch their 
                  first products, supported growing businesses with digital transformation, 
                  and partnered with established companies to modernize their systems.
                </p>
                <Quote
                  className="size-10 fill-white/20 self-end mt-3"
                  strokeWidth={0}
