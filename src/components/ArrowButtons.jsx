...
export const ArrowScrollButton = ({ children, to, variant = "primary" }) => {
  const buttonClass = variant === "secondary" 
    ? "secondary-btn cursor-pointer text-white mt-5 w-fit mx-auto" 
    : "primary-btn cursor-pointer text-black mt-5 w-fit mx-auto";
